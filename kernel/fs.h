...
struct compression_header {
    uint magic;           // Magic number to identify compressed file
    uint length;          // Original file length
    uint compressed_size; // Size after compression
    uint method;          // Compression method used
};
